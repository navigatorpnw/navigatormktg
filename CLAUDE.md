...
- `fuel_docks_system_design_v4_38.md` — Complete technical reference for Fuel Docks
- `my_fuel_dock_system_design_v1.19.md` — MFD architecture, database, API, and roadmap
